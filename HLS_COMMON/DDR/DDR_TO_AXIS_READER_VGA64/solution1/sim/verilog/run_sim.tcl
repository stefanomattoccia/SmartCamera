...
if {[file isfile ddr_to_axis_reader.autotvin.dat]} {
	file delete -force ddr_to_axis_reader.autotvin.dat
}

if {[file isfile ddr_to_axis_reader.autotvout.dat]} {
	file delete -force ddr_to_axis_reader.autotvout.dat
}
