...
(* CORE_GENERATION_INFO="ddr_to_axis_reader,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=346576,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=1,HLS_SYN_FF=854,HLS_SYN_LUT=1783}" *)
...
reg   [0:0] tmp_7_reg_569_pp1_iter1_reg;
...
reg   [9:0] indvar_reg_221;
reg   [9:0] indvar_reg_221_pp0_iter1_reg;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [12:0] j_reg_233;
wire   [31:0] tmp_fu_250_p1;
reg   [31:0] tmp_reg_523;
wire   [3:0] tmp_cast_fu_258_p1;
reg   [3:0] tmp_cast_reg_528;
wire   [6:0] i_1_fu_284_p2;
reg   [6:0] i_1_reg_541;
reg    ap_sig_ioackin_base_ddr_addr_ARREADY;
reg    ap_block_state2_io;
wire   [0:0] exitcond1_fu_353_p2;
reg   [0:0] exitcond1_reg_555_pp0_iter1_reg;
wire   [9:0] indvar_next_fu_359_p2;
reg   [9:0] indvar_next_reg_559;
reg    ap_enable_reg_pp0_iter0;
reg   [63:0] base_ddr_addr_addr_r_reg_564;
...
wire   [12:0] j_1_fu_376_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [2:0] tmp_8_fu_382_p1;
reg   [2:0] tmp_8_reg_578;
wire   [7:0] tmp_26_fu_512_p1;
wire   [18:0] offset_fu_517_p2;
...
reg    buffer_ce1;
reg    buffer_we1;
reg   [18:0] offset1_reg_200;
reg   [6:0] i_reg_210;
reg   [9:0] ap_phi_mux_indvar_phi_fu_225_p4;
wire   [63:0] indvar1_fu_365_p1;
wire   [63:0] gepindex2_cast_fu_396_p1;
wire   [63:0] tmp_5_fu_290_p1;
reg    ap_reg_ioackin_base_ddr_addr_ARREADY;
wire   [31:0] tmp_3_fu_305_p2;
wire   [31:0] tmp_6_fu_335_p2;
wire   [0:0] tmp_4_fu_326_p2;
wire    ap_block_pp1_stage0_01001;
wire   [2:0] inner_index_V_2_fu_244_p2;
wire   [2:0] tmp_1_fu_262_p0;
wire   [21:0] tmp_1_fu_262_p2;
wire   [3:0] tmp_2_fu_322_p1;
wire   [8:0] gepindex_cast_fu_386_p4;
wire   [5:0] start_pos_fu_401_p3;
wire   [5:0] end_pos_fu_408_p2;
wire   [6:0] tmp_11_fu_420_p1;
wire   [6:0] tmp_12_fu_424_p1;
wire   [0:0] tmp_10_fu_414_p2;
wire   [6:0] tmp_14_fu_438_p2;
wire   [6:0] tmp_16_fu_450_p2;
reg   [63:0] tmp_13_fu_428_p4;
wire   [6:0] tmp_15_fu_444_p2;
wire   [6:0] tmp_17_fu_456_p3;
wire   [6:0] tmp_19_fu_472_p3;
wire   [6:0] tmp_20_fu_480_p2;
wire   [63:0] tmp_18_fu_464_p3;
wire   [63:0] tmp_21_fu_486_p1;
wire   [63:0] tmp_22_fu_490_p1;
wire   [63:0] tmp_23_fu_494_p2;
wire   [63:0] tmp_24_fu_500_p2;
wire   [63:0] tmp_25_fu_506_p2;
reg   [11:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
reg    ap_idle_pp1;
wire    ap_enable_pp1;
wire   [21:0] tmp_1_fu_262_p00;
...
#0 index_old = 32'd4294967295;
#0 frame_count_equals_i = 32'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_reg_555 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_reg_221 <= indvar_next_reg_559;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        indvar_reg_221 <= 10'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        j_reg_233 <= 13'd0;
    end else if (((tmp_7_fu_370_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        ...
        offset1_reg_200 <= {{tmp_1_fu_262_p2[21:3]}};
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_reg_555 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((outStream_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io)) & (tmp_4_fu_326_p2 == 1'd1) & (exitcond_fu_278_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        frame_count_equals_i <= tmp_6_fu_335_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((outStream_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io)) & (exitcond_fu_278_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_7_fu_370_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        tmp_cast_reg_528[2 : 0] <= tmp_cast_fu_258_p1[2 : 0];
        tmp_reg_523[2 : 0] <= tmp_fu_250_p1[2 : 0];
    end
end

always @ (*) begin
    if ((exitcond1_fu_353_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond1_reg_555 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_fu_278_p2 == 1'd0) & (outStream_V_1_ack_in == 1'b1) & (ap_reg_ioackin_base_ddr_addr_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((exitcond1_reg_555_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        buffer_we1 = 1'b1;
    end else begin
        buffer_we1 = 1'b0;
    end
...
always @ (*) begin
    if (((tmp_7_reg_569 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((tmp_7_reg_569_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter2 == 1'b1) & (1'b0 == ap_block_pp1_stage0)) | ((tmp_7_reg_569 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((outStream_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io)) & (exitcond_fu_278_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((outStream_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state2_io)) & (exitcond_fu_278_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond1_fu_353_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((exitcond1_fu_353_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if ((~((tmp_7_fu_370_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b0)) & ~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter2 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if ((((tmp_7_fu_370_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b0)) | ((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter2 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond1_reg_555 == 1'd0) & (base_ddr_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond1_reg_555 == 1'd0) & (base_ddr_addr_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond1_reg_555 == 1'd0) & (base_ddr_addr_RVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state14_io = ((tmp_7_reg_569 == 1'd0) & (outStream_V_1_ack_in == 1'b0));
end

assign ap_block_state14_pp1_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state15_io = ((tmp_7_reg_569_pp1_iter1_reg == 1'd0) & (outStream_V_1_ack_in == 1'b0));
end

assign ap_block_state15_pp1_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_io = ((exitcond_fu_278_p2 == 1'd0) & (ap_sig_ioackin_base_ddr_addr_ARREADY == 1'b0));
end
...
assign base_ddr_addr_ARADDR = tmp_5_fu_290_p1;

assign buffer_address0 = gepindex2_cast_fu_396_p1;

assign buffer_address1 = indvar1_fu_365_p1;

assign end_pos_fu_408_p2 = (start_pos_fu_401_p3 | 6'd7);

assign exitcond1_fu_353_p2 = ((ap_phi_mux_indvar_phi_fu_225_p4 == 10'd512) ? 1'b1 : 1'b0);

assign exitcond_fu_278_p2 = ((i_reg_210 == 7'd75) ? 1'b1 : 1'b0);

assign frame_count = (32'd1 + frame_count_inner);

assign frame_count_equals = (frame_count_equals_i + 32'd1);

assign gepindex2_cast_fu_396_p1 = gepindex_cast_fu_386_p4;

assign gepindex_cast_fu_386_p4 = {{j_reg_233[11:3]}};

assign i_1_fu_284_p2 = (i_reg_210 + 7'd1);

assign indvar1_fu_365_p1 = indvar_reg_221_pp0_iter1_reg;

assign indvar_next_fu_359_p2 = (ap_phi_mux_indvar_phi_fu_225_p4 + 10'd1);

assign inner_index_V_2_fu_244_p2 = ($signed(frame_index_V) + $signed(3'd7));

assign j_1_fu_376_p2 = (j_reg_233 + 13'd1);

assign offset_fu_517_p2 = (offset1_reg_200 + 19'd512);
...
assign start_pos_fu_401_p3 = {{tmp_8_reg_578}, {3'd0}};

assign tmp_10_fu_414_p2 = ((start_pos_fu_401_p3 > end_pos_fu_408_p2) ? 1'b1 : 1'b0);

assign tmp_11_fu_420_p1 = start_pos_fu_401_p3;

assign tmp_12_fu_424_p1 = end_pos_fu_408_p2;
...
always @ (buffer_q0) begin
    for (ap_tvar_int_0 = 64 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 63 - 0) begin
            tmp_13_fu_428_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_13_fu_428_p4[ap_tvar_int_0] = buffer_q0[63 - ap_tvar_int_0];
        end
    end
end

assign tmp_14_fu_438_p2 = (tmp_11_fu_420_p1 - tmp_12_fu_424_p1);

assign tmp_15_fu_444_p2 = (tmp_11_fu_420_p1 ^ 7'd63);

assign tmp_16_fu_450_p2 = (tmp_12_fu_424_p1 - tmp_11_fu_420_p1);

assign tmp_17_fu_456_p3 = ((tmp_10_fu_414_p2[0:0] === 1'b1) ? tmp_14_fu_438_p2 : tmp_16_fu_450_p2);

assign tmp_18_fu_464_p3 = ((tmp_10_fu_414_p2[0:0] === 1'b1) ? tmp_13_fu_428_p4 : buffer_q0);

assign tmp_19_fu_472_p3 = ((tmp_10_fu_414_p2[0:0] === 1'b1) ? tmp_15_fu_444_p2 : tmp_11_fu_420_p1);

assign tmp_1_fu_262_p0 = tmp_1_fu_262_p00;

assign tmp_1_fu_262_p00 = inner_index_V_2_fu_244_p2;

assign tmp_1_fu_262_p2 = (tmp_1_fu_262_p0 * $signed('h4B000));

assign tmp_20_fu_480_p2 = (7'd63 - tmp_17_fu_456_p3);

assign tmp_21_fu_486_p1 = tmp_19_fu_472_p3;

assign tmp_22_fu_490_p1 = tmp_20_fu_480_p2;

assign tmp_23_fu_494_p2 = tmp_18_fu_464_p3 >> tmp_21_fu_486_p1;

assign tmp_24_fu_500_p2 = 64'd18446744073709551615 >> tmp_22_fu_490_p1;

assign tmp_25_fu_506_p2 = (tmp_24_fu_500_p2 & tmp_23_fu_494_p2);

assign tmp_26_fu_512_p1 = tmp_25_fu_506_p2[7:0];

assign tmp_2_fu_322_p1 = index_old[3:0];

assign tmp_3_fu_305_p2 = (32'd1 + frame_count_inner);

assign tmp_4_fu_326_p2 = ((tmp_cast_reg_528 == tmp_2_fu_322_p1) ? 1'b1 : 1'b0);

assign tmp_5_fu_290_p1 = offset1_reg_200;

assign tmp_6_fu_335_p2 = (frame_count_equals_i + 32'd1);

assign tmp_7_fu_370_p2 = ((j_reg_233 == 13'd4096) ? 1'b1 : 1'b0);

assign tmp_8_fu_382_p1 = j_reg_233[2:0];

assign tmp_cast_fu_258_p1 = inner_index_V_2_fu_244_p2;

assign tmp_fu_250_p1 = inner_index_V_2_fu_244_p2;

always @ (posedge ap_clk) begin
    tmp_reg_523[31:3] <= 29'b00000000000000000000000000000;
    tmp_cast_reg_528[3] <= 1'b0;
end
