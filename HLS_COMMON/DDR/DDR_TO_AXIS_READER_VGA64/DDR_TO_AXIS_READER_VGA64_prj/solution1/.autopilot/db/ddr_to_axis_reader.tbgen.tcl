...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "ddr_to_axis_reader",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "346576", "EstimateLatencyMax" : "346576",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"InDataflowNetwork" : "0",
		"Port" : [
			{"Name" : "outStream_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "outStream_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			...
			{"Name" : "frame_count_equals", "Type" : "None", "Direction" : "O"},
			{"Name" : "frame_count_inner", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "index_old", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "frame_count_equals_i", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_to_axis_reader_base_ddr_addr_m_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buffer_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	ddr_to_axis_reader {
		outStream_V {Type O LastRead -1 FirstWrite 11}
		...
		frame_count_equals {Type O LastRead -1 FirstWrite 1}
		frame_count_inner {Type IO LastRead -1 FirstWrite -1}
		index_old {Type IO LastRead -1 FirstWrite -1}
		frame_count_equals_i {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "346576", "Max" : "346576"}
	, {"Name" : "Interval", "Min" : "346577", "Max" : "346577"}
]}
