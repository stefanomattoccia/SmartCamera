set C_TypeInfoList {{ 
"ddr_to_axis_reader_SD" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"outStream_channel_1": [[], {"reference": "0"}] }, {"outstream_channel_2": [[], {"reference": "0"}] }, {"base_ddr_addr": [[],{ "pointer": "1"}] }, {"base_address": [[],"2"] }, {"frame_buffer_dim": [[],"2"] }, {"frame_buffer_offset": [[],"2"] }, {"frame_buffer_number": [[],"3"] }, {"update_intr": [[], {"scalar": "bool"}] }, {"stereo_enabler": [[], {"scalar": "bool"}] }],[],""], 
"0": [ "stream<unsigned char>", {"hls_type": {"stream": [[[[], {"scalar": "unsigned char"}]],"4"]}}], 
"2": [ "u32", {"typedef": [[[], {"scalar": "unsigned int"}],""]}], 
"3": [ "u8", {"typedef": [[[], {"scalar": "unsigned char"}],""]}], 
"1": [ "u64", {"typedef": [[[], {"scalar": "long long unsigned int"}],""]}],
"4": ["hls", ""]
}}
set moduleName ddr_to_axis_reader_SD
...
set C_modelName {ddr_to_axis_reader_SD}
set C_modelType { void 0 }
set C_modelArgList {
	{ outStream_channel_1_V int 8 regular {axi_s 1 volatile  { outStream_channel_1_V Data } }  }
	{ outstream_channel_2_V int 8 regular {axi_s 1 volatile  { outstream_channel_2_V Data } }  }
	...
	{ stereo_enabler uint 1 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "outStream_channel_1_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "outStream_channel_1.V","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "outstream_channel_2_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "outstream_channel_2.V","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "stereo_enabler", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "stereo_enabler","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":56}, "offset_end" : {"in":63}} ]}
# RTL Port declarations: 
set portNum 71
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst_n sc_in sc_logic 1 reset -1 active_low_sync } 
	{ outStream_channel_1_V_TDATA sc_out sc_lv 8 signal 0 } 
	{ outStream_channel_1_V_TVALID sc_out sc_logic 1 outvld 0 } 
	{ outStream_channel_1_V_TREADY sc_in sc_logic 1 outacc 0 } 
	{ outstream_channel_2_V_TDATA sc_out sc_lv 8 signal 1 } 
	{ outstream_channel_2_V_TVALID sc_out sc_logic 1 outvld 1 } 
	{ outstream_channel_2_V_TREADY sc_in sc_logic 1 outacc 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"ddr_to_axis_reader_SD","role":"start","value":"0","valid_bit":"0"},{"name":"ddr_to_axis_reader_SD","role":"continue","value":"0","valid_bit":"4"},{"name":"ddr_to_axis_reader_SD","role":"auto_start","value":"0","valid_bit":"7"},{"name":"base_address","role":"data","value":"16"},{"name":"frame_buffer_dim","role":"data","value":"24"},{"name":"frame_buffer_offset","role":"data","value":"32"},{"name":"frame_buffer_number","role":"data","value":"40"},{"name":"update_intr","role":"data","value":"48"},{"name":"stereo_enabler","role":"data","value":"56"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"ddr_to_axis_reader_SD","role":"start","value":"0","valid_bit":"0"},{"name":"ddr_to_axis_reader_SD","role":"done","value":"0","valid_bit":"1"},{"name":"ddr_to_axis_reader_SD","role":"idle","value":"0","valid_bit":"2"},{"name":"ddr_to_axis_reader_SD","role":"ready","value":"0","valid_bit":"3"},{"name":"ddr_to_axis_reader_SD","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "outStream_channel_1_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outStream_channel_1_V", "role": "TDATA" }} , 
 	{ "name": "outStream_channel_1_V_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "outStream_channel_1_V", "role": "TVALID" }} , 
 	{ "name": "outStream_channel_1_V_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "outStream_channel_1_V", "role": "TREADY" }} , 
 	{ "name": "outstream_channel_2_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outstream_channel_2_V", "role": "TDATA" }} , 
 	{ "name": "outstream_channel_2_V_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "outstream_channel_2_V", "role": "TVALID" }} , 
 	{ "name": "outstream_channel_2_V_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "outstream_channel_2_V", "role": "TREADY" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"InDataflowNetwork" : "0",
		"Port" : [
			{"Name" : "outStream_channel_1_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "outStream_channel_1_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "outstream_channel_2_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "outstream_channel_2_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "base_ddr_addr", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "base_ddr_addr_blk_n_AR", "Type" : "RtlSignal"},
					{"Name" : "base_ddr_addr_blk_n_R", "Type" : "RtlSignal"}]},
			...
			{"Name" : "stereo_enabler", "Type" : "None", "Direction" : "I"},
			{"Name" : "inner_index", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "guard_variable_for_d_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "FRAME_BUFFER_DIM_r", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "guard_variable_for_d", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "FRAME_OFFSET", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "guard_variable_for_d_1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "FRAME_BUFFER_NUMBER_r", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "guard_variable_for_d_3", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "BASE_ADDRESS_r", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "luma_chroma_switch", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_to_axis_reader_SD_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_to_axis_reader_SD_base_ddr_addr_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buffer_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	ddr_to_axis_reader_SD {
		outStream_channel_1_V {Type O LastRead -1 FirstWrite 11}
		outstream_channel_2_V {Type O LastRead -1 FirstWrite 11}
		base_ddr_addr {Type I LastRead 9 FirstWrite -1}
		...
		stereo_enabler {Type I LastRead 0 FirstWrite -1}
		inner_index {Type IO LastRead -1 FirstWrite -1}
		guard_variable_for_d_2 {Type IO LastRead -1 FirstWrite -1}
		FRAME_BUFFER_DIM_r {Type IO LastRead -1 FirstWrite -1}
		guard_variable_for_d {Type IO LastRead -1 FirstWrite -1}
		FRAME_OFFSET {Type IO LastRead -1 FirstWrite -1}
		guard_variable_for_d_1 {Type IO LastRead -1 FirstWrite -1}
		FRAME_BUFFER_NUMBER_r {Type IO LastRead -1 FirstWrite -1}
		guard_variable_for_d_3 {Type IO LastRead -1 FirstWrite -1}
		BASE_ADDRESS_r {Type IO LastRead -1 FirstWrite -1}
		luma_chroma_switch {Type IO LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	outStream_channel_1_V { axis {  { outStream_channel_1_V_TDATA out_data 1 8 }  { outStream_channel_1_V_TVALID out_vld 1 1 }  { outStream_channel_1_V_TREADY out_acc 0 1 } } }
	outstream_channel_2_V { axis {  { outstream_channel_2_V_TDATA out_data 1 8 }  { outstream_channel_2_V_TVALID out_vld 1 1 }  { outstream_channel_2_V_TREADY out_acc 0 1 } } }
