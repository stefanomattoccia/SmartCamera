set C_TypeInfoList {{ 
"axis_to_ddr_writer" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inputStream": [[], {"reference": "0"}] }, {"base_ddr_addr": [[],{ "pointer": "1"}] }, {"frame_index": [[],{ "pointer": "2"}] }, {"frame_count": [[],{ "pointer":  {"scalar": "unsigned int"}}] }, {"base_address": [[],"3"] }, {"frame_buffer_dim": [[],"3"] }, {"frame_buffer_offset": [[],"3"] }, {"frame_buffer_number": [[],"4"] }, {"update_intr": [[], {"scalar": "bool"}] }],[],""], 
