...
HLS_SOURCES = ../../../testbench.cpp ../../../axis_to_ddr_writer.cpp
...
$(ObjDir)/axis_to_ddr_writer.o: ../../../axis_to_ddr_writer.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../axis_to_ddr_writer.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/axis_to_ddr_writer.d
