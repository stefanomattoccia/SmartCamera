...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axis_to_ddr_writer.autotvin.dat"
	set constFileTvOut       "axis_to_ddr_writer.autotvout.dat"
	set constFileHdlTvIn     "axis_to_ddr_writer.autohdltvin.dat"
	set constFileHdlTvOut    "axis_to_ddr_writer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
