...
if {[file isfile axis_to_ddr_writer.autotvin.dat]} {
	file delete -force axis_to_ddr_writer.autotvin.dat
}

if {[file isfile axis_to_ddr_writer.autotvout.dat]} {
	file delete -force axis_to_ddr_writer.autotvout.dat
}
