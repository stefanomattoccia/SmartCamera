...
architecture behav of axis_to_ddr_writer is 
    ...
    "axis_to_ddr_writer,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=346351,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=1,HLS_SYN_FF=768,HLS_SYN_LUT=1150}";
    ...
    signal exitcond1_reg_357 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond1_reg_357_pp1_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal indvar_flatten_reg_190 : STD_LOGIC_VECTOR (12 downto 0);
    signal indvar_reg_201 : STD_LOGIC_VECTOR (9 downto 0);
    signal inner_index_V_load_reg_323 : STD_LOGIC_VECTOR (2 downto 0);
    signal exitcond_fu_237_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal idx_1_fu_243_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal idx_1_reg_337 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond_flatten_fu_277_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal indvar_flatten_next_fu_283_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal indvar_next_fu_306_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_enable_reg_pp1_iter0 : STD_LOGIC := '0';
    signal buffer_q0 : STD_LOGIC_VECTOR (63 downto 0);
    signal buffer_load_reg_371 : STD_LOGIC_VECTOR (63 downto 0);
    signal offset_fu_317_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal offset_reg_376 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal offset1_reg_169 : STD_LOGIC_VECTOR (18 downto 0);
    signal idx_reg_179 : STD_LOGIC_VECTOR (6 downto 0);
    signal indvar1_fu_312_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_7_fu_289_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_base_ddr_addr_AWREADY : STD_LOGIC := '0';
    signal ap_reg_ioackin_base_ddr_addr_WREADY : STD_LOGIC := '0';
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal tmp_4_fu_249_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_6_fu_264_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal frame_index_V_preg : STD_LOGIC_VECTOR (2 downto 0) := "000";
    signal tmp_1_fu_221_p0 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1_fu_221_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_idle_pp0 : STD_LOGIC;
    signal ap_enable_pp0 : STD_LOGIC;
    signal ap_idle_pp1 : STD_LOGIC;
    signal ap_enable_pp1 : STD_LOGIC;
    signal tmp_1_fu_221_p00 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((exitcond_fu_237_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((exitcond1_reg_357_pp1_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((exitcond_fu_237_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    idx_reg_179_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_237_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                indvar_flatten_reg_190 <= ap_const_lv13_0;
            elsif (((exitcond_flatten_fu_277_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                indvar_flatten_reg_190 <= indvar_flatten_next_fu_283_p2;
            end if; 
        end if;
    end process;

    indvar_reg_201_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_300_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    offset1_reg_169_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((base_ddr_addr_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state13))) then 
                offset1_reg_169 <= offset_reg_376;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                offset1_reg_169 <= tmp_1_fu_221_p2(21 downto 3);
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_reg_357 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state5, ap_enable_reg_pp1_iter2, ap_CS_fsm_state13, base_ddr_addr_BVALID, exitcond_fu_237_p2, ap_CS_fsm_state2, exitcond_flatten_fu_277_p2, ap_enable_reg_pp0_iter0, ap_sig_ioackin_base_ddr_addr_AWREADY, exitcond1_fu_300_p2, ap_enable_reg_pp1_iter0, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone, ap_enable_reg_pp1_iter1)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((exitcond_flatten_fu_277_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((exitcond_flatten_fu_277_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if ((not(((exitcond1_fu_300_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) and not(((ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif ((((exitcond1_fu_300_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)) or ((ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1)))) then
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(inputStream_V_0_vld_out, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_342)
    begin
                ap_block_pp0_stage0_11001 <= ((exitcond_flatten_reg_342 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(inputStream_V_0_vld_out, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_342)
    begin
                ap_block_pp0_stage0_subdone <= ((exitcond_flatten_reg_342 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state4_pp0_stage0_iter1_assign_proc : process(inputStream_V_0_vld_out, exitcond_flatten_reg_342)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((exitcond_flatten_reg_342 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0));
    end process;

        ap_block_state6_pp1_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state7_pp1_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state8_io_assign_proc : process(exitcond1_reg_357_pp1_iter1_reg, ap_sig_ioackin_base_ddr_addr_WREADY)
    begin
                ap_block_state8_io <= ((exitcond1_reg_357_pp1_iter1_reg = ap_const_lv1_0) and (ap_sig_ioackin_base_ddr_addr_WREADY = ap_const_logic_0));
    end process;

        ap_block_state8_pp1_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state3_assign_proc : process(exitcond_flatten_fu_277_p2)
    begin
        if ((exitcond_flatten_fu_277_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp1_exit_iter0_state6_assign_proc : process(exitcond1_fu_300_p2)
    begin
        if ((exitcond1_fu_300_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(exitcond_fu_237_p2, ap_CS_fsm_state2)
    begin
        if (((exitcond_fu_237_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(exitcond_fu_237_p2, ap_CS_fsm_state2)
    begin
        if (((exitcond_fu_237_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    base_ddr_addr_AWADDR <= tmp_7_fu_289_p1(32 - 1 downto 0);
    ...
    base_ddr_addr_WVALID_assign_proc : process(ap_enable_reg_pp1_iter2, exitcond1_reg_357_pp1_iter1_reg, ap_reg_ioackin_base_ddr_addr_WREADY, ap_block_pp1_stage0_01001)
    begin
        if (((exitcond1_reg_357_pp1_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_01001) and (ap_reg_ioackin_base_ddr_addr_WREADY = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))) then 
    ...
    base_ddr_addr_blk_n_W_assign_proc : process(m_axi_base_ddr_addr_WREADY, ap_enable_reg_pp1_iter2, ap_block_pp1_stage0, exitcond1_reg_357_pp1_iter1_reg)
    begin
        if (((exitcond1_reg_357_pp1_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0))) then 
    ...
    buffer_address0 <= indvar1_fu_312_p1(9 - 1 downto 0);
    ...
    exitcond1_fu_300_p2 <= "1" when (indvar_reg_201 = ap_const_lv10_200) else "0";
    exitcond_flatten_fu_277_p2 <= "1" when (indvar_flatten_reg_190 = ap_const_lv13_1000) else "0";
    exitcond_fu_237_p2 <= "1" when (idx_reg_179 = ap_const_lv7_4B) else "0";
    ...
    idx_1_fu_243_p2 <= std_logic_vector(unsigned(idx_reg_179) + unsigned(ap_const_lv7_1));
    indvar1_fu_312_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(indvar_reg_201),64));
    indvar_flatten_next_fu_283_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_190) + unsigned(ap_const_lv13_1));
    indvar_next_fu_306_p2 <= std_logic_vector(unsigned(indvar_reg_201) + unsigned(ap_const_lv10_1));

    inputStream_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_342, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond_flatten_reg_342 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    inputStream_V_TDATA_blk_n_assign_proc : process(inputStream_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_342)
    begin
        if (((exitcond_flatten_reg_342 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    offset_fu_317_p2 <= std_logic_vector(unsigned(offset1_reg_169) + unsigned(ap_const_lv19_200));
    tmp_1_fu_221_p0 <= tmp_1_fu_221_p00(3 - 1 downto 0);
    tmp_1_fu_221_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(inner_index_V),22));
    tmp_1_fu_221_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_221_p0) * unsigned(ap_const_lv22_4B000), 22));
    tmp_4_fu_249_p2 <= std_logic_vector(unsigned(inner_index_V_load_reg_323) + unsigned(ap_const_lv3_1));
    tmp_6_fu_264_p2 <= std_logic_vector(unsigned(frame_count_inner) + unsigned(ap_const_lv32_1));
    tmp_7_fu_289_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(offset1_reg_169),64));
end behav;
