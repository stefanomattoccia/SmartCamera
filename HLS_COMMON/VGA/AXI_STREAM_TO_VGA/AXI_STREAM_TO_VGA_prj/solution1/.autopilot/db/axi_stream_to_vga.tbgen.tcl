set C_TypeInfoList {{ 
"axi_stream_to_vga" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"selftest": [[], {"scalar": "bool"}] }, {"inStream": [[], {"reference": "0"}] }, {"R": [[],{ "pointer": "1"}] }, {"G": [[],{ "pointer": "1"}] }, {"B": [[],{ "pointer": "1"}] }, {"V_SYNC": [[],{ "pointer": "2"}] }, {"H_SYNC": [[],{ "pointer": "2"}] }],[],""], 
...
set C_modelName {axi_stream_to_vga}
...
set ArgLastReadFirstWriteLatency {
	axi_stream_to_vga {
		...
		V_SYNC_V {Type O LastRead -1 FirstWrite 1}
		H_SYNC_V {Type O LastRead -1 FirstWrite 1}
