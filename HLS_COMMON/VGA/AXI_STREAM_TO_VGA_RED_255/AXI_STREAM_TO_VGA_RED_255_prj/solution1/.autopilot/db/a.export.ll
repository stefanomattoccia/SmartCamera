...
@axi_stream_to_vga_re = internal unnamed_addr constant [26 x i8] c"axi_stream_to_vga_red_255\00"
...
codeRepl:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1 %selftest), !map !71
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %inStream_V_V), !map !77
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %R_V), !map !81
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %G_V), !map !85
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %B_V), !map !89
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %V_SYNC_V), !map !93
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %H_SYNC_V), !map !97
...
.preheader:                                       ; preds = %codeRepl, %10
  %indvar_flatten = phi i19 [ 0, %codeRepl ], [ %indvar_flatten_next, %10 ]
  %y = phi i10 [ 0, %codeRepl ], [ %y_mid2, %10 ]
  %x = phi i10 [ 0, %codeRepl ], [ %x_1, %10 ]
...
; <label>:0                                       ; preds = %.preheader.preheader
  br i1 %selftest_read, label %4, label %1

; <label>:1                                       ; preds = %0
  br i1 %tmp, label %2, label %.get_checkerboard_color.exit_crit_edge15
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_9 = icmp eq i8 %tmp_V, -1
  br i1 %tmp_9, label %.get_checkerboard_color.exit_crit_edge, label %3
...
; <label>:4                                       ; preds = %0
  ...
  %tmp_10 = call i1 @_ssdm_op_BitSelect.i1.i11.i32(i11 %p_Val2_s, i32 5)
  %tmp_1_i = zext i1 %tmp_10 to i19
...
get_checkerboard_color.exit:                      ; preds = %.get_checkerboard_color.exit_crit_edge15, %.get_checkerboard_color.exit_crit_edge, %8, %7, %6, %5, %4, %3
...
.preheader.preheader:                             ; preds = %.preheader
  ...
  br i1 %or_cond2, label %0, label %9
...
!74 = metadata !{metadata !"selftest", metadata !75, metadata !"bool", i32 0, i32 0}
!75 = metadata !{metadata !76}
!76 = metadata !{i32 0, i32 0, i32 0}
!77 = metadata !{metadata !78}
!78 = metadata !{i32 0, i32 7, metadata !79}
!79 = metadata !{metadata !80}
!80 = metadata !{metadata !"inStream.V.V", metadata !69, metadata !"uint8", i32 0, i32 7}
!81 = metadata !{metadata !82}
!82 = metadata !{i32 0, i32 3, metadata !83}
!83 = metadata !{metadata !84}
!84 = metadata !{metadata !"R.V", metadata !69, metadata !"uint4", i32 0, i32 3}
!85 = metadata !{metadata !86}
!86 = metadata !{i32 0, i32 3, metadata !87}
!87 = metadata !{metadata !88}
!88 = metadata !{metadata !"G.V", metadata !69, metadata !"uint4", i32 0, i32 3}
!89 = metadata !{metadata !90}
!90 = metadata !{i32 0, i32 3, metadata !91}
!91 = metadata !{metadata !92}
!92 = metadata !{metadata !"B.V", metadata !69, metadata !"uint4", i32 0, i32 3}
!93 = metadata !{metadata !94}
!94 = metadata !{i32 0, i32 0, metadata !95}
!95 = metadata !{metadata !96}
!96 = metadata !{metadata !"V_SYNC.V", metadata !69, metadata !"uint1", i32 0, i32 0}
!97 = metadata !{metadata !98}
!98 = metadata !{i32 0, i32 0, metadata !99}
!99 = metadata !{metadata !100}
!100 = metadata !{metadata !"H_SYNC.V", metadata !69, metadata !"uint1", i32 0, i32 0}
