...
architecture behav of ov7670_LUMA_CHROMA is 
    ...
    "ov7670_LUMA_CHROMA,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.287000,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=95,HLS_SYN_LUT=229}";
    ...
    signal enable_raw_stream_re_read_fu_48_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_6_fu_81_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state5 : BOOLEAN;
    signal ap_predicate_op32_write_state5 : BOOLEAN;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((not(((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_grayscale_V_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state5_io))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((outStream_grayscale_V_V_1_ack_in = ap_const_logic_1) and (outStream_grayscale_V_V_1_vld_in = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((((outStream_grayscale_V_V_1_state = ap_const_lv2_1) and (outStream_grayscale_V_V_1_ack_out = ap_const_logic_0)) or ((outStream_grayscale_V_V_1_state = ap_const_lv2_3) and (outStream_grayscale_V_V_1_ack_out = ap_const_logic_0) and (outStream_grayscale_V_V_1_vld_in = ap_const_logic_1)))) then 
                    outStream_grayscale_V_V_1_state <= ap_const_lv2_1;
                elsif (((not(((outStream_grayscale_V_V_1_vld_in = ap_const_logic_0) and (outStream_grayscale_V_V_1_ack_out = ap_const_logic_1))) and not(((outStream_grayscale_V_V_1_ack_out = ap_const_logic_0) and (outStream_grayscale_V_V_1_vld_in = ap_const_logic_1))) and (outStream_grayscale_V_V_1_state = ap_const_lv2_3)) or ((outStream_grayscale_V_V_1_state = ap_const_lv2_1) and (outStream_grayscale_V_V_1_ack_out = ap_const_logic_1)) or ((outStream_grayscale_V_V_1_state = ap_const_lv2_2) and (outStream_grayscale_V_V_1_vld_in = ap_const_logic_1)))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, inStream_V_V_0_vld_out, outStream_grayscale_V_V_1_ack_in, outStream_LUMA_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in, grayscale_valid, ap_CS_fsm_state2, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state3, ap_block_state2_io, ap_block_state5_io, ap_block_state3_io, ap_block_state4_io)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                ...
                elsif ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (grayscale_valid = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_block_state2_io_assign_proc : process(outStream_grayscale_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in, grayscale_valid, ap_predicate_op24_write_state2)
    begin
                ap_block_state2_io <= (((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) and (ap_predicate_op24_write_state2 = ap_const_boolean_1)) or ((grayscale_valid = ap_const_lv1_1) and (outStream_grayscale_V_V_1_ack_in = ap_const_logic_0)));
    end process;


    ap_block_state3_io_assign_proc : process(outStream_CHROMA_V_V_1_ack_in, enable_raw_stream_re_read_fu_48_p2)
    begin
                ap_block_state3_io <= ((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0));
    end process;


    ap_block_state4_io_assign_proc : process(outStream_grayscale_V_V_1_ack_in, outStream_LUMA_V_V_1_ack_in, enable_raw_stream_re_read_fu_48_p2)
    begin
                ap_block_state4_io <= ((outStream_grayscale_V_V_1_ack_in = ap_const_logic_0) or ((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (outStream_LUMA_V_V_1_ack_in = ap_const_logic_0)));
    end process;


    ap_block_state5_assign_proc : process(outStream_grayscale_V_V_1_ack_in, outStream_LUMA_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in)
    begin
                ap_block_state5 <= ((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_grayscale_V_V_1_ack_in = ap_const_logic_0));
    end process;


    ap_block_state5_io_assign_proc : process(outStream_LUMA_V_V_1_ack_in, ap_predicate_op32_write_state5)
    begin
                ap_block_state5_io <= ((outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) and (ap_predicate_op32_write_state5 = ap_const_boolean_1));
    end process;


    ap_done_assign_proc : process(outStream_grayscale_V_V_1_ack_in, outStream_LUMA_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in, ap_CS_fsm_state5, ap_block_state5_io)
    begin
        if ((not(((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_grayscale_V_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state5_io))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    ap_predicate_op24_write_state2_assign_proc : process(grayscale_valid, enable_raw_stream_re_read_fu_48_p2)
    begin
                ap_predicate_op24_write_state2 <= ((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (grayscale_valid = ap_const_lv1_0));
    end process;


    ap_predicate_op32_write_state5_assign_proc : process(enable_raw_stream_re_read_fu_48_p2, grayscale_valid_load_reg_103)
    begin
                ap_predicate_op32_write_state5 <= ((grayscale_valid_load_reg_103 = ap_const_lv1_1) and (enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1));
    end process;


    ap_ready_assign_proc : process(outStream_grayscale_V_V_1_ack_in, outStream_LUMA_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in, ap_CS_fsm_state5, ap_block_state5_io)
    begin
        if ((not(((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) or (outStream_grayscale_V_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state5_io))) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    enable_raw_stream_re_read_fu_48_p2 <= (0=>enable_raw_stream, others=>'-');
    ...
    outStream_CHROMA_V_V_1_vld_in_assign_proc : process(inStream_V_V_0_vld_out, ap_CS_fsm_state2, ap_predicate_op24_write_state2, ap_block_state2_io)
    begin
        if ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (ap_predicate_op24_write_state2 = ap_const_boolean_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    outStream_CHROMA_V_V_TDATA_blk_n_assign_proc : process(outStream_CHROMA_V_V_1_state, grayscale_valid, ap_CS_fsm_state2, enable_raw_stream_re_read_fu_48_p2, ap_CS_fsm_state3)
    begin
        if ((((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3)) or ((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (grayscale_valid = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    outStream_LUMA_V_V_1_vld_in_assign_proc : process(ap_CS_fsm_state4, enable_raw_stream_re_read_fu_48_p2, ap_block_state4_io)
    begin
        if (((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state4_io) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    outStream_LUMA_V_V_TDATA_blk_n_assign_proc : process(outStream_LUMA_V_V_1_state, ap_CS_fsm_state4, enable_raw_stream_re_read_fu_48_p2, ap_CS_fsm_state5, grayscale_valid_load_reg_103)
    begin
        if ((((grayscale_valid_load_reg_103 = ap_const_lv1_1) and (enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5)) or ((enable_raw_stream_re_read_fu_48_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
    ...
    outStream_grayscale_V_V_1_vld_in_assign_proc : process(inStream_V_V_0_vld_out, grayscale_valid, ap_CS_fsm_state2, ap_block_state2_io)
    begin
    ...
    outStream_grayscale_V_V_TDATA_blk_n_assign_proc : process(outStream_grayscale_V_V_1_state, grayscale_valid, ap_CS_fsm_state2, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((grayscale_valid = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    tmp_6_fu_81_p2 <= (grayscale_valid_load_reg_103 xor ap_const_lv1_1);
end behav;
