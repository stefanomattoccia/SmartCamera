...
if {[file isfile pattern_generator.autotvin.dat]} {
	file delete -force pattern_generator.autotvin.dat
}

if {[file isfile pattern_generator.autotvout.dat]} {
	file delete -force pattern_generator.autotvout.dat
}
