...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pattern_generator.autotvin.dat"
	set constFileTvOut       "pattern_generator.autotvout.dat"
	set constFileHdlTvIn     "pattern_generator.autohdltvin.dat"
	set constFileHdlTvOut    "pattern_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
