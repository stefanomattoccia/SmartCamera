...
(* CORE_GENERATION_INFO="ov7670_grayscale,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.287000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=45,HLS_SYN_LUT=117}" *)
...
reg   [0:0] grayscale_valid_load_reg_66;
reg    ap_block_state2_io;
wire   [0:0] tmp_3_fu_50_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((~((outStream_V_V_1_ack_in == 1'b0) | (1'b1 == ap_block_state3_io)) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((outStream_V_V_1_vld_out == 1'b1) & (outStream_V_V_1_ack_out == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((outStream_V_V_1_vld_in == 1'b1) & (outStream_V_V_1_ack_in == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((outStream_V_V_1_state == 2'd2) & (outStream_V_V_1_vld_in == 1'b0)) | ((outStream_V_V_1_state == 2'd3) & (outStream_V_V_1_vld_in == 1'b0) & (outStream_V_V_1_ack_out == 1'b1)))) begin
            outStream_V_V_1_state <= 2'd2;
        end else if ((((outStream_V_V_1_state == 2'd1) & (outStream_V_V_1_ack_out == 1'b0)) | ((outStream_V_V_1_state == 2'd3) & (outStream_V_V_1_ack_out == 1'b0) & (outStream_V_V_1_vld_in == 1'b1)))) begin
            outStream_V_V_1_state <= 2'd1;
        end else if (((~((outStream_V_V_1_vld_in == 1'b0) & (outStream_V_V_1_ack_out == 1'b1)) & ~((outStream_V_V_1_ack_out == 1'b0) & (outStream_V_V_1_vld_in == 1'b1)) & (outStream_V_V_1_state == 2'd3)) | ((outStream_V_V_1_state == 2'd1) & (outStream_V_V_1_ack_out == 1'b1)) | ((outStream_V_V_1_state == 2'd2) & (outStream_V_V_1_vld_in == 1'b1)))) begin
...
always @ (*) begin
    if ((((grayscale_valid_load_reg_66 == 1'd1) & (1'b1 == ap_CS_fsm_state3)) | ((grayscale_valid == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    ap_block_state2_io = ((grayscale_valid == 1'd1) & (outStream_V_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((grayscale_valid_load_reg_66 == 1'd1) & (outStream_V_V_1_ack_in == 1'b0));
end
...
assign tmp_3_fu_50_p2 = (grayscale_valid_load_reg_66 ^ 1'd1);
