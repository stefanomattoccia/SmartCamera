...
set Library     "hls"
set IPName      "convolution_filter"
set Version     "1.0"
set DisplayName "Convolution_filter"
set Revision    "1709191106"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "convolution_filter"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {}
        memories "kernel_config_V {base_address 64 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS in_img_V out_img_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 41.666668 machine 64 combinational 0 latency 310598 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Luca/Desktop/ProgettoVivado/OV_7670/HLS_COMMON/FILTERS/Configurable_Convolution_Filter/configurable_convolution_filter.cpp}
if {$enable_xo_gen} {
