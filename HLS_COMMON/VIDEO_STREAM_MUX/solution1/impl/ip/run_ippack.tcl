...
set Library     "hls"
set IPName      "mux_sd_ov"
set Version     "1.0"
set DisplayName "Mux_sd_ov"
set Revision    "1709221004"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 switch_stream W 0x0 "Data signal of switch_stream" {{0 1 switch_stream W 0 "Bit 0 to 0 Data signal of switch_stream"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS data_in_sd_V_V data_in_ov7670_V_V outputStream_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    data_in_ov7670_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "data_in_ov7670_V_V"
        has_tready "1"
        ports {
            TDATA 8
        }
...
set enable_xo_gen 0
set kernel_files {F:/Progetti_Vivado_Tesi/Test_7_Tesi/HLS_COMMON/VIDEO_STREAM_MUX/mux_sd_ov.cpp}
if {$enable_xo_gen} {
