...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ov7670_interface.autotvin_data_in_V.dat"
         "c.ov7670_interface.autotvin_href_V.dat"
         "c.ov7670_interface.autotvin_vsync_V.dat"
         "c.ov7670_interface.autotvout_data_out_V.dat"
         "c.ov7670_interface.autotvout_line_valid_V.dat"
         "c.ov7670_interface.autotvout_frame_valid_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ov7670_interface.autotvout_data_out_V.dat"
         "rtl.ov7670_interface.autotvout_line_valid_V.dat"
         "rtl.ov7670_interface.autotvout_frame_valid_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
