...
if {[file isfile ov7670_interface.autotvin.dat]} {
	file delete -force ov7670_interface.autotvin.dat
}

if {[file isfile ov7670_interface.autotvout.dat]} {
	file delete -force ov7670_interface.autotvout.dat
}
