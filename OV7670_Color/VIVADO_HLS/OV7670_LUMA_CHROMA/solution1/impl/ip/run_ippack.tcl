...
set Library     "hls"
set IPName      "ov7670_LUMA_CHROMA"
set Version     "1.0"
set DisplayName "Ov7670_luma_chroma"
set Revision    "1708191309"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "ov7670_LUMA_CHROMA"
...
set Interfaces {
    ap_clk {
        ...
        buses "inStream_V_V outStream_grayscale_V_V outStream_LUMA_V_V outStream_CHROMA_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    outStream_grayscale_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "outStream_grayscale_V_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    outStream_LUMA_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "outStream_LUMA_V_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    outStream_CHROMA_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "outStream_CHROMA_V_V"
        has_tready "1"
        ports {
            TDATA 8
        }
...
set enable_xo_gen 0
set kernel_files {D:/000_OFFICIAL_OV_VISION_PIPELINE_COLOR_2017/OV_7670/OV7670_Color/VIVADO_HLS/OV7670_LUMA_CHROMA/ov7670_LUMA_CHROMA.cpp}
if {$enable_xo_gen} {
