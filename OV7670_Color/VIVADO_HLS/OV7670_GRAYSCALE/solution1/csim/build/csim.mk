...
HLS_SOURCES = ../../../testbench.cpp ../../../ov7670_grayscale.cpp
...
$(ObjDir)/ov7670_grayscale.o: ../../../ov7670_grayscale.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../ov7670_grayscale.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/ov7670_grayscale.d
