...
if {[file isfile ov7670_grayscale.autotvin.dat]} {
	file delete -force ov7670_grayscale.autotvin.dat
}

if {[file isfile ov7670_grayscale.autotvout.dat]} {
	file delete -force ov7670_grayscale.autotvout.dat
}
