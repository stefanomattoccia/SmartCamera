...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ov7670_grayscale.autotvin_inStream_V_V.dat"
         "c.ov7670_grayscale.autotvin_outStream_V_V.dat"
         "c.ov7670_grayscale.autotvout_outStream_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ov7670_grayscale.autotvout_outStream_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
