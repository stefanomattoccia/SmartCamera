...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = convolution_filter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Convolution_Filter_convolution_filter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sep_convolution_filter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Convolution_Filter_sep_convolution_filter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ddr_to_axis_reader_SD
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = OV7670_GRAYSCALE_TO_AXIS_ddr_to_axis_reader_SD_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mux_sd_ov
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = OV7670_GRAYSCALE_TO_AXIS_mux_sd_ov_1
END
