...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LF_valid_to_AXIS.autotvin.dat"
	set constFileTvOut       "LF_valid_to_AXIS.autotvout.dat"
	set constFileHdlTvIn     "LF_valid_to_AXIS.autohdltvin.dat"
	set constFileHdlTvOut    "LF_valid_to_AXIS.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
