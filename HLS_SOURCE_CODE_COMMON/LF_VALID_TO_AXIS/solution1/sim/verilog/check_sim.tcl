...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.LF_valid_to_AXIS.autotvin_data_in_V.dat"
         "c.LF_valid_to_AXIS.autotvin_frame_valid.dat"
         "c.LF_valid_to_AXIS.autotvin_line_valid.dat"
         "c.LF_valid_to_AXIS.autotvin_outputStream_V_V.dat"
         "c.LF_valid_to_AXIS.autotvout_outputStream_V_V.dat"
         "c.LF_valid_to_AXIS.autotvout_frame_offset.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.LF_valid_to_AXIS.autotvout_outputStream_V_V.dat"
         "rtl.LF_valid_to_AXIS.autotvout_frame_offset.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
