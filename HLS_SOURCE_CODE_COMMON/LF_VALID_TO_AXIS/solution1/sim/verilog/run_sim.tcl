...
if {[file isfile LF_valid_to_AXIS.autotvin.dat]} {
	file delete -force LF_valid_to_AXIS.autotvin.dat
}

if {[file isfile LF_valid_to_AXIS.autotvout.dat]} {
	file delete -force LF_valid_to_AXIS.autotvout.dat
}
