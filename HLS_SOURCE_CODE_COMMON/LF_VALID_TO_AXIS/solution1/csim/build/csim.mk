...
HLS_SOURCES = ../../../testbench.cpp ../../../LF_valid_to_AXIS.cpp
...
$(ObjDir)/LF_valid_to_AXIS.o: ../../../LF_valid_to_AXIS.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../LF_valid_to_AXIS.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/LF_valid_to_AXIS.d
