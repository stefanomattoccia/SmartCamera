...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "mux_sd_ov", "VariableLatency" : "0", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "switch_stream", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "data_in_sd_V_V", "Type" : "Axis", "Direction" : "I", "BlockSignal" : [
			{"Name" : "data_in_sd_V_V_TDATA_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}, 
		{"Name" : "data_in_ov7670_V_V", "Type" : "Axis", "Direction" : "I", "BlockSignal" : [
			{"Name" : "data_in_ov7670_V_V_TDATA_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}, 
		{"Name" : "outputStream_V_V", "Type" : "Axis", "Direction" : "O", "BlockSignal" : [
			{"Name" : "outputStream_V_V_TDATA_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_sd_ov_AXILiteS_s_axi_U", "Parent" : "0", "Child" : []}]}
