...
HLS_SOURCES = ../../../testbench.cpp ../../../vga_bram_read_address.cpp
...
$(ObjDir)/vga_bram_read_address.o: ../../../vga_bram_read_address.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../vga_bram_read_address.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/vga_bram_read_address.d
