...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vga_bram_read_address.autotvin.dat"
	set constFileTvOut       "vga_bram_read_address.autotvout.dat"
	set constFileHdlTvIn     "vga_bram_read_address.autohdltvin.dat"
	set constFileHdlTvOut    "vga_bram_read_address.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
