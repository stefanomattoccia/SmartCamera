...
AUTOPILOT_ROOT := d:/Xilinx/Vivado_HLS/2015.3
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := d:/Xilinx/Vivado_HLS/2015.3/msys/bin
endif
...
$(ObjDir)/vga_bram_read_address.cpp_pre.cpp.tb.o : vga_bram_read_address.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling vga_bram_read_address.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
