 ...
 * 			 frame di errore.
 */
void axi_stream_to_vga_red_255(bool selftest, hls::stream<PIXEL> &inStream, volatile ap_uint<BIT_OUT> *R, volatile ap_uint<BIT_OUT> *G, volatile ap_uint<BIT_OUT> *B, volatile ap_uint<1> *V_SYNC, volatile ap_uint<1> *H_SYNC);
