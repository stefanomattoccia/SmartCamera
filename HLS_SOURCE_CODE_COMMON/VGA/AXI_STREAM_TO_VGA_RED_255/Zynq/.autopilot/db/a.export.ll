...
@axi_stream_to_vga_red_255_str = internal unnamed_addr constant [26 x i8] c"axi_stream_to_vga_red_255\00"
...
; <label>:1                                       ; preds = %0
  br i1 %tmp, label %2, label %get_checkerboard_color.exit.pre6

; <label>:2                                       ; preds = %1
  %tmp_V = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inStream_V_V)
  %tmp_6 = icmp eq i8 %tmp_V, -1
  br i1 %tmp_6, label %get_checkerboard_color.exit.pre, label %3
...
; <label>:4                                       ; preds = %0
  %tmp_7 = call i1 @_ssdm_op_BitSelect.i1.i10.i32(i10 %p_Val2_1, i32 5)
  %tmp_8 = call i1 @_ssdm_op_BitSelect.i1.i11.i32(i11 %p_Val2_s, i32 5)
  %tmp_1_i = zext i1 %tmp_8 to i19
  %tmp_2_i = call i21 @_ssdm_op_BitConcatenate.i21.i1.i19.i1(i1 false, i19 %tmp_1_i, i1 %tmp_7)
