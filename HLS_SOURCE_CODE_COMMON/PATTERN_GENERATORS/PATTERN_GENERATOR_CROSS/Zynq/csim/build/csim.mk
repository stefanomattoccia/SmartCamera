...
HLS_SOURCES = ../../../test.cpp ../../../pattern_generator.cpp
...
$(ObjDir)/pattern_generator.o: ../../../pattern_generator.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../pattern_generator.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/pattern_generator.d
