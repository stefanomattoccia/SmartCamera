...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ddr_to_axis_reader.autotvin_outStream_V.dat"
         "c.ddr_to_axis_reader.autotvin_base_ddr_addr.dat"
         "c.ddr_to_axis_reader.autotvin_frame_index_V.dat"
         "c.ddr_to_axis_reader.autotvout_outStream_V.dat"
         "c.ddr_to_axis_reader.autotvout_frame_count.dat"
         "c.ddr_to_axis_reader.autotvout_frame_count_equals.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ddr_to_axis_reader.autotvout_outStream_V.dat"
         "rtl.ddr_to_axis_reader.autotvout_frame_count.dat"
         "rtl.ddr_to_axis_reader.autotvout_frame_count_equals.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
