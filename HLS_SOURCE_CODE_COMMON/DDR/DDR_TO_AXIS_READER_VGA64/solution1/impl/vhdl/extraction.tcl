...
proc extract_area_rodin { uti_file } {
    ...
    set return_value [list $slice_count $lut_count $ff_count $mult_count $bram_count $latch_count $srl_count $clb_count]
...
proc extract_total_rodin { uti_file } {
    ...
    set return_value [list $slice_count $lut_count $ff_count $dsp_count $bram_count18 $clb_count]
