...
HLS_SOURCES = ../../../testbench.cpp ../../../ddr_to_axis_reader.cpp
...
$(ObjDir)/ddr_to_axis_reader.o: ../../../ddr_to_axis_reader.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../ddr_to_axis_reader.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/ddr_to_axis_reader.d
