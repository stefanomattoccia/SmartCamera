...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ddr_to_axis_reader.autotvin.dat"
	set constFileTvOut       "ddr_to_axis_reader.autotvout.dat"
	set constFileHdlTvIn     "ddr_to_axis_reader.autohdltvin.dat"
	set constFileHdlTvOut    "ddr_to_axis_reader.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
