...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.axis_to_ddr_writer.autotvin_inputStream_V.dat"
         "c.axis_to_ddr_writer.autotvout_base_ddr_addr.dat"
         "c.axis_to_ddr_writer.autotvout_frame_index_V.dat"
         "c.axis_to_ddr_writer.autotvout_frame_count.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.axis_to_ddr_writer.autotvout_base_ddr_addr.dat"
         "rtl.axis_to_ddr_writer.autotvout_frame_index_V.dat"
         "rtl.axis_to_ddr_writer.autotvout_frame_count.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
