...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("kernel_config_V_address0", 6, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("kernel_config_V_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("kernel_config_V_q0", 8, hls_in, 0, "ap_memory", "mem_dout", 1),
...
const char* HLS_Design_Meta::dut_name = "sep_convolution_filter";
