...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convolution_filter.autotvin.dat"
	set constFileTvOut       "convolution_filter.autotvout.dat"
	set constFileHdlTvIn     "convolution_filter.autohdltvin.dat"
	set constFileHdlTvOut    "convolution_filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
